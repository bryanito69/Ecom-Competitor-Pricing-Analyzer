Ecom-Competitor-Pricing-Analyzer

Automated e-commerce competitor pricing analysis system built with Python, SerpApi, BeautifulSoup, and fuzzy matching.

# Features
- Queries Google Shopping through SerpApi
